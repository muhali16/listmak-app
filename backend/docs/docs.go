...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/admin/payments": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "order_id / guest name / whatsapp",
                        "name": "search",
                        "in": "query"
                    }
                ],
        ...
        "/admin/payments/{orderId}/reconcile": {
            "post": {
                "produces": [
                    "application/json"
                ],
        ...
        "/payments/webhook": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Pakasir webhook payload",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/payments/{orderId}/cancel": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Invoice / Pakasir order id",
                        "name": "orderId",
                        "in": "path",
                        "required": true
                    }
    ...
    "definitions": {
        "models.Listmak": {
            ...
            "properties": {
                ...
                "is_sandbox": {
                    "description": "created while app in testing mode; hidden in production, badged in admin",
                    "type": "boolean"
                },
                "orders": {
                    "type": "array",
        ...
        "models.Order": {
            ...
            "properties": {
                ...
                "paid_amount": {
                    "description": "frozen amount paid via QR at payment time; unaffected by later price edits",
                    "type": "number"
                },
                "paid_at": {
                    "type": "string"
                ...
                "payment_id": {
                    "description": "set when this order is covered by a guest Payment",
                    "type": "integer"
                },
                "price": {
                    "type": "number"
